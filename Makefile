...
pkgdatadir = $(datadir)/projet4
pkgincludedir = $(includedir)/projet4
pkglibdir = $(libdir)/projet4
pkglibexecdir = $(libexecdir)/projet4
...
am_projet4_OBJECTS = main.$(OBJEXT) support.$(OBJEXT) \
	interface.$(OBJEXT) callbacks.$(OBJEXT) client.$(OBJEXT)
projet4_OBJECTS = $(am_projet4_OBJECTS)
am__DEPENDENCIES_1 =
projet4_DEPENDENCIES = $(am__DEPENDENCIES_1)
AM_V_P = $(am__v_P_$(V))
...
am__v_CCLD_1 = 
SOURCES = $(projet4_SOURCES)
DIST_SOURCES = $(projet4_SOURCES)
...
ACLOCAL = ${SHELL} /home/aymen/Téléchargements/projet4/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /home/aymen/Téléchargements/projet4/missing autoconf
AUTOHEADER = ${SHELL} /home/aymen/Téléchargements/projet4/missing autoheader
AUTOMAKE = ${SHELL} /home/aymen/Téléchargements/projet4/missing automake-1.15
AWK = mawk
CATALOGS = 
CATOBJEXT = .gmo
CC = gcc
...
LTLIBOBJS = 
MAINT = 
MAKEINFO = ${SHELL} /home/aymen/Téléchargements/projet4/missing makeinfo
MKDIR_P = /bin/mkdir -p
...
abs_builddir = /home/aymen/Téléchargements/projet4/src
abs_srcdir = /home/aymen/Téléchargements/projet4/src
abs_top_builddir = /home/aymen/Téléchargements/projet4
abs_top_srcdir = /home/aymen/Téléchargements/projet4
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /home/aymen/Téléchargements/projet4/install-sh
...
projet4_LDADD = -lgtk-x11-2.0 -lgdk-x11-2.0 -lpangocairo-1.0 -latk-1.0 -lcairo -lgdk_pixbuf-2.0 -lgio-2.0 -lpangoft2-1.0 -lpango-1.0 -lgobject-2.0 -lglib-2.0 -lfontconfig -lfreetype $(INTLLIBS)
all: all-am
...
projet4$(EXEEXT): $(projet4_OBJECTS) $(projet4_DEPENDENCIES) $(EXTRA_projet4_DEPENDENCIES) 
	@rm -f projet4$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(projet4_OBJECTS) $(projet4_LDADD) $(LIBS)
